// Canvas-based interactive grid that lights up around the cursor and
// pulses outward on click. Adapted from React Bits for TrafficIQ —
// tuned via props at the call site rather than hardcoded here.
